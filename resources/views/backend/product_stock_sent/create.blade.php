...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Send Product Stock') }}</div>
                    ...
                    <form method="POST" action="{{ route('product-sends.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="unit" type="number" min="1" class="form-control @error('unit') is-invalid @enderror" name="unit" value="{{ old('unit') }}" required autocomplete="name" autofocus>
